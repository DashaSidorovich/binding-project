sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/bindingApp/app", ".html");
		...
		return Opa5.extend("zjblessons.bindingApp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/bindingApp/localService/mockserver"], function (mockserver) {
